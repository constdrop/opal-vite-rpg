...
> インストーラーを実行とは  
Windowsなら「エクスプローラー→ダウンロード」、Macなら「Finder→ダウンロード」でダウンロードしたファイルを開くことです。  
...
- Webを開くと下の画面が出てくるので「Download」を押し、ダウンロードしましょう。

![alt text](<スクリーンショット 2026-03-31 142900.png>)

### 2. インストーラーを実行してGitを入れる
- 上記2つと同じ要領で入れることができます。
